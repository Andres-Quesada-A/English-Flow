    ...
    sections: [
      ...
      },
      {
        ...
        words: [
          ...
          { english: 'behave', spanish: '2 significados: 1) comportarse (persona) · 2) funcionar / reaccionar (un sistema)', example: 'Behave yourself in the meeting.', example2: 'The app behaves strangely under heavy load.' },
          { english: 'treat', spanish: '2 significados: 1) tratar (a alguien) · 2) invitar / pagar algo', example: 'You should treat your teammates with respect.', example2: "Lunch is on me, it's my treat." },
      ...
      },
      {
        ...
        words: [
          ...
          { english: 'quote', spanish: '2 significados: 1) cotización / presupuesto · 2) cita (o citar)', example: 'Can you send me a quote for the project?', example2: 'He quoted a line from the docs.' },
          { english: 'thought', spanish: '2 significados: 1) idea / pensamiento · 2) pensé (pasado de "think")', example: "That's a good thought, let's try it.", example2: 'I thought so.' },
          { english: 'otherwise', spanish: 'de lo contrario / si no', example: 'Fix the failing tests, otherwise the build stays broken.' },
          { english: 'slipped', spanish: '2 significados (pasado de "slip"): 1) resbaló · 2) se olvidó ("slip one\'s mind")', example: 'He slipped on the wet floor.', example2: 'It slipped my mind to reply to your email.' },
      ...
      },
      {
        ...
        words: [
          ...
          { english: 'charge', spanish: '2 significados: 1) cobrar · 2) cargar (batería)', example: 'How much do they charge for the license?', example2: "My phone won't charge." },
      ...
      },
      {
        ...
        words: [
          ...
          { english: 'squeeze', spanish: '2 significados: 1) apretar / exprimir · 2) meter algo con dificultad', example: 'Squeeze the lemon into the glass.', example2: 'Can you squeeze this task into today?' },
      ...
      },
      {
        ...
        words: [
          ...
          { english: 'mushy', spanish: '2 significados: 1) blando / pastoso · 2) cursi / meloso', example: 'The vegetables were overcooked and mushy.', example2: 'That movie was too mushy for me.' },
          { english: 'dry', spanish: 'seco', example: 'The cake was a bit dry. / My throat is dry from talking all day.' },
          { english: 'spoiled', spanish: '2 significados: 1) echado a perder (comida) · 2) malcriado / consentido (persona)', example: 'The milk is spoiled, throw it out.', example2: 'That kid is really spoiled.' },
          ...
          { english: 'puff', spanish: '2 significados: 1) bocanada / calada · 2) inflado / hojaldrado (puff pastry = hojaldre)', example: 'He took a puff of his vape.', example2: 'Puff pastry is my favorite.' },
        ],
      },
      {
        ...
        words: [
          ...
          { english: 'crane', spanish: '2 significados: 1) grúa (máquina) · 2) grulla (el ave)', example: 'A crane lifted the beams onto the roof.', example2: 'A crane is also a tall, elegant bird.' },
          ...
          { english: 'dump', spanish: '2 significados: 1) botar / tirar (o vertedero) · 2) dejar / botar a la pareja', example: "Don't dump your trash here.", example2: 'She dumped him last week.' },
        ],
      },
      {
      ...
      },
      {
        ...
        words: [
          ...
          { english: 'swear', spanish: '2 significados: 1) jurar / prometer · 2) decir groserías / maldecir', example: 'I swear I fixed that bug.', example2: 'Try not to swear in the meeting.' },
      ...
      },
      {
        ...
        words: [
          ...
          { english: 'curb', spanish: '2 significados: 1) bordillo de la acera (EE. UU.) · 2) refrenar / controlar', example: 'The car hit the curb.', example2: 'We need to curb our spending.' },
          ...
          { english: 'cane', spanish: '2 significados: 1) bastón · 2) caña (sugar cane = caña de azúcar)', example: 'My grandfather walks with a cane.', example2: 'Sugar cane grows all over this region.' },
          { english: 'sails', spanish: 'velas (de un barco)', example: "The boat's sails caught the wind." },
          { english: 'nail', spanish: '3 significados: 1) uña · 2) clavo · 3) "nail it" = clavarla / lograrlo perfecto', example: 'I broke a nail. / Hammer the nail into the wall.', example2: 'You totally nailed the presentation!' },
      ...
      },
      {
        ...
        words: [
          ...
          { english: 'homemade', spanish: 'casero / hecho en casa', example: 'I love homemade food more than takeout.' },
        ],
      },
      {
        title: 'Más naturaleza y animales (More nature & animals)',
        words: [
      ...
      },
      {
        ...
        words: [
          ...
          { english: 'haunting', spanish: 'inquietante / que te persigue (haunt = embrujar)', example: 'The song has a haunting melody.' },
        ],
      },
      {
        title: 'Cuerpo y salud (Body & health)',
        words: [
      ...
      },
      {
        ...
        words: [
          ...
          { english: 'shaming', spanish: 'avergonzar / señalar con vergüenza (shame)', example: 'Public shaming online is really cruel.' },
          { english: 'flexing', spanish: 'presumir / alardear (slang; también: flexionar)', example: "He's always flexing his new gadgets." },
          { english: 'impersonate', spanish: 'hacerse pasar por / suplantar / imitar', example: 'Someone tried to impersonate the CEO by email.' },
          ...
          { english: 'trap', spanish: 'trampa (también: atrapar)', example: 'The bug is a trap for careless users.' },
          ...
          { english: 'gasp', spanish: 'jadear / quedarse sin aliento / ahogo de sorpresa', example: 'The crowd let out a gasp.' },
          { english: 'rage', spanish: 'furia / ira', example: 'He was shaking with rage.' },
        ],
      },
      {
        title: 'Lugares y emergencias (Places & emergencies)',
        words: [
          ...
          { english: 'fireplug', spanish: 'hidrante (sinónimo informal de fire hydrant)', example: 'Kids opened the fireplug to cool off in summer.' },
          { english: 'bullets', spanish: 'balas (también: viñetas, "bullet points")', example: 'The police found empty bullets on the ground.' },
        ],
      },
      {
        ...
        words: [
          ...
          { english: 'least', spanish: 'el menos / lo mínimo ("at least" = al menos)', example: 'At least the tests are passing now.' },
          { english: 'spare', spanish: 'de repuesto / de sobra (también: spare time = tiempo libre)', example: 'Do you have a spare charger?' },
          { english: 'though', spanish: 'aunque / sin embargo', example: 'It works, though it could be faster.' },
          { english: 'foreshadowing', spanish: 'presagio / anticipación (adelantar lo que va a pasar)', example: 'That comment was foreshadowing the ending.' },
          { english: 'jesters', spanish: 'bufones', example: 'The court jesters made the king laugh.' },
          { english: 'mascot', spanish: 'mascota (de un equipo o marca)', example: 'The team mascot danced during the game.' },
        ],
      },
      {
        ...
        words: [
          ...
          { english: "let's hit the road", spanish: 'vámonos / pongámonos en marcha', example: "It's getting late — let's hit the road." },
        ],
      },
    ],
