const ipaDict: Record<string, string> = {
  ...
  'silk': '/sɪlk/',
  'stubborn': '/ˈstʌb.ərn/',
  'deodorant': '/diˈoʊ.dər.ənt/',
  'flexing': '/ˈfleks.ɪŋ/',
  'though': '/ðoʊ/',
  'vacuum': '/ˈvæk.juːm/',
  'vaccine': '/vækˈsiːn/',
  'impersonate': '/ɪmˈpɜːr.sən.eɪt/',
  'overwhelmed': '/ˌoʊ.vərˈwelmd/',
  'diaper': '/ˈdaɪ.pər/',
  'greet': '/ɡriːt/',
  'mascot': '/ˈmæs.kɒt/',
  'rob': '/rɒb/',
  'redeem': '/rɪˈdiːm/',
  'fiberglass': '/ˈfaɪ.bər.ɡlæs/',
  'mattress': '/ˈmæt.rəs/',
  'garment': '/ˈɡɑːr.mənt/',
  'tablecloth': '/ˈteɪ.bəl.klɒθ/',
  'fire hydrant': '/ˈfaɪər ˌhaɪ.drənt/',
  'hydrant': '/ˈhaɪ.drənt/',
  'fireplug': '/ˈfaɪər.plʌɡ/',
  'least': '/liːst/',
  'lobster': '/ˈlɒb.stər/',
  'soaps': '/soʊps/',
  ...
  'proud': '/praʊd/',
  'salted': '/ˈsɔːl.tɪd/',
  'nearsighted': '/ˌnɪrˈsaɪ.tɪd/',
  'badger': '/ˈbædʒ.ər/',
  'jesters': '/ˈdʒes.tərz/',
  'farsighted': '/ˌfɑːrˈsaɪ.tɪd/',
  'swings': '/swɪŋz/',
  'homemade': '/ˌhoʊmˈmeɪd/',
  'passed out': '/pæst aʊt/',
  'sweat': '/swet/',
  'foreshadowing': '/ˈfɔːrˌʃæd.oʊ.ɪŋ/',
  'spare': '/sper/',
  'trap': '/træp/',
  'dodge': '/dɒdʒ/',
  'bullets': '/ˈbʊl.ɪts/',
  "don't you dare": '/doʊnt juː der/',
  'dumb and dumber': '/dʌm ənd ˈdʌm.ər/',
  "let's hit the road": '/lets hɪt ðə roʊd/',

  // Personal vocabulary (batch 4)
  'bin': '/bɪn/',
  'pretzels': '/ˈpret.səlz/',
  'sprinkles': '/ˈsprɪŋ.kəlz/',
  'fondant': '/ˈfɒn.dənt/',
  'allowance': '/əˈlaʊ.əns/',
  'dough': '/doʊ/',
  'shopped': '/ʃɒpt/',
  'piping bag': '/ˈpaɪ.pɪŋ bæɡ/',
  'knob': '/nɒb/',
  'replacement': '/rɪˈpleɪs.mənt/',
  'trade': '/treɪd/',
  'handwriting': '/ˈhænd.raɪ.tɪŋ/',
  'illogical': '/ɪˈlɒdʒ.ɪ.kəl/',
  'rare': '/rer/',
  'weather forecast': '/ˈweð.ər ˌfɔːr.kæst/',
  'convey': '/kənˈveɪ/',
  'attach': '/əˈtætʃ/',
  'quit': '/kwɪt/',
  'quite': '/kwaɪt/',
